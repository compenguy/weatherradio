...
impl Measurement {
    pub(crate) fn name(&self) -> &'static str {
        match self {
            Measurement::BatteryOk(_) => "batteryok",
            Measurement::BatteryLevelRaw(_) => "batterylevel",
            Measurement::Temperature(_) => "temperature",
            Measurement::RelativeHumidity(_) => "humidity",
            Measurement::Clock(_) => "time",
            Measurement::Rainfall(_) => "rainfall",
            Measurement::Lux(_) => "lux",
            Measurement::WindSpeed(_) => "windspeed",
            Measurement::WindGust(_) => "windgust",
            Measurement::WindDirection(_) => "winddirection",
        }
    }
}
